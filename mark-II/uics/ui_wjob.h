...
public:
    ...
    void setupUi(QWidget *uiJob)
    {
        if (uiJob->objectName().isEmpty())
            uiJob->setObjectName(QStringLiteral("uiJob"));
        uiJob->resize(1009, 600);
        verticalLayout = new QVBoxLayout(uiJob);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        groupBox_2 = new QGroupBox(uiJob);
        ...
        groupBox_6 = new QGroupBox(uiJob);
        ...
        ownWidget = new uiBookWidget(groupBox_6);
        ...
        groupBox_3 = new QGroupBox(uiJob);
        ...
        tabWidget = new QTabWidget(uiJob);
        ...
        QMetaObject::connectSlotsByName(uiJob);
    } // setupUi

    void retranslateUi(QWidget *uiJob)
    {
        uiJob->setWindowTitle(QApplication::translate("uiJob", "Form", 0));
        groupBox_2->setTitle(QApplication::translate("uiJob", "Con el Trabajo Actual", 0));
        otherJobButton->setText(QApplication::translate("uiJob", "Otro Trabajo, misma personas", 0));
        sameWorkButton->setText(QApplication::translate("uiJob", "Mismo, diferente Personas", 0));
        differentButton->setText(QApplication::translate("uiJob", "Diferente, diferentes Personas", 0));
        groupBox->setTitle(QApplication::translate("uiJob", "Para el:", 0));
        fechaLabel->setText(QApplication::translate("uiJob", "Fecha:", 0));
        fechaDateEdit->setDisplayFormat(QApplication::translate("uiJob", "dddd dd/MM", 0));
        horaLabel->setText(QApplication::translate("uiJob", "Hora:", 0));
        horaTimeEdit->setDisplayFormat(QApplication::translate("uiJob", "H:mm", 0));
        groupBox_6->setTitle(QApplication::translate("uiJob", "Trabajos", 0));
        ownButton->setText(QApplication::translate("uiJob", "Propio:", 0));
        bookButton->setText(QApplication::translate("uiJob", "Libro:", 0));
        fileButton->setText(QApplication::translate("uiJob", "Archivo:", 0));
        groupBox_3->setTitle(QApplication::translate("uiJob", "Operaciones:", 0));
        saveButton->setText(QApplication::translate("uiJob", "Guardar", 0));
        markFinishedButton->setText(QApplication::translate("uiJob", "Marcar Como Terminado", 0));
        discardButton->setText(QApplication::translate("uiJob", "Descartar", 0));
        reprintButton->setText(QApplication::translate("uiJob", "Reimprimir", 0));
        ignoreCheckBox->setText(QApplication::translate("uiJob", "Ignorar Completo", 0));
    } // retranslateUi

};

namespace Ui {
    class uiJob: public Ui_uiJob {};
} // namespace Ui
