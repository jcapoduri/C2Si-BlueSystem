...
public:
    ...
    {
        wWorkList->setWindowTitle(QApplication::translate("wWorkList", "Listado de Trabajos", 0, QApplication::UnicodeUTF8));
        filterGroupBox->setTitle(QApplication::translate("wWorkList", "Filtro", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("wWorkList", "Buscar:", 0, QApplication::UnicodeUTF8));
        searchButton->setText(QApplication::translate("wWorkList", "Buscar", 0, QApplication::UnicodeUTF8));
        clientCheckBox->setText(QApplication::translate("wWorkList", "Cliente", 0, QApplication::UnicodeUTF8));
        descriptionCheckBox->setText(QApplication::translate("wWorkList", "Descripcion", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("wWorkList", "Estado", 0, QApplication::UnicodeUTF8));
        recibidoCheckBox->setText(QApplication::translate("wWorkList", "Recibido", 0, QApplication::UnicodeUTF8));
        fotocopiandoCheckBox->setText(QApplication::translate("wWorkList", "Fotocopiando", 0, QApplication::UnicodeUTF8));
        anillandoCheckBox->setText(QApplication::translate("wWorkList", "Anillando", 0, QApplication::UnicodeUTF8));
        terminadoCheckBox->setText(QApplication::translate("wWorkList", "Terminado", 0, QApplication::UnicodeUTF8));
        entregadoCheckBox->setText(QApplication::translate("wWorkList", "Entregado", 0, QApplication::UnicodeUTF8));
        recicladoCheckBox->setText(QApplication::translate("wWorkList", "Reciclado", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("wWorkList", "Desde:", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("wWorkList", "Hasta:", 0, QApplication::UnicodeUTF8));
        listaCheckBox->setText(QApplication::translate("wWorkList", "Lista", 0, QApplication::UnicodeUTF8));
        printButton->setText(QApplication::translate("wWorkList", "Imprimir", 0, QApplication::UnicodeUTF8));
        closeButton->setText(QApplication::translate("wWorkList", "Cerrar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
