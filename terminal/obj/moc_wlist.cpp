...
**
** Created: Sat 2. Feb 04:52:07 2013
...
static const char qt_meta_stringdata_wList[] = {
    "wList\0\0updated()\0update()\0print()\0"
};
...
const QMetaObjectExtraData wList::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject wList::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_wList,
      qt_meta_data_wList, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &wList::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_wList))
