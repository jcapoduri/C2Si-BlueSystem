...
struct qt_meta_stringdata_booksList_t {
    QByteArrayData data[4];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_booksList_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_booksList_t qt_meta_stringdata_booksList = {
    {
QT_MOC_LITERAL(0, 0, 9), // "booksList"
QT_MOC_LITERAL(1, 10, 9), // "queryDone"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5) // "query"

    },
    "booksList\0queryDone\0\0query"
};
...
void booksList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (booksList::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&booksList::queryDone)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject booksList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_booksList.data,
      qt_meta_data_booksList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *booksList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_booksList.stringdata))
