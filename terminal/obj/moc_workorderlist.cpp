...
struct qt_meta_stringdata_workorderList_t {
    QByteArrayData data[4];
    char stringdata[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_workorderList_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_workorderList_t qt_meta_stringdata_workorderList = {
    {
QT_MOC_LITERAL(0, 0, 13), // "workorderList"
QT_MOC_LITERAL(1, 14, 9), // "queryDone"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5) // "query"

    },
    "workorderList\0queryDone\0\0query"
};
...
void workorderList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (workorderList::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&workorderList::queryDone)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject workorderList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_workorderList.data,
      qt_meta_data_workorderList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *workorderList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_workorderList.stringdata))
