...
public:
    ...
    {
        wworkorder_pages->setWindowTitle(QApplication::translate("wworkorder_pages", "Desde/Hasta", 0, QApplication::UnicodeUTF8));
        desdeLabel->setText(QApplication::translate("wworkorder_pages", "Desde:", 0, QApplication::UnicodeUTF8));
        hastaLabel->setText(QApplication::translate("wworkorder_pages", "Hasta:", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("wworkorder_pages", "Dejando Hasta en -1, indica que se haga hasta el final", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
