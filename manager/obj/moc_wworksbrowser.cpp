...
struct qt_meta_stringdata_wWorksBrowser_t {
    QByteArrayData data[5];
    char stringdata[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_wWorksBrowser_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_wWorksBrowser_t qt_meta_stringdata_wWorksBrowser = {
    {
QT_MOC_LITERAL(0, 0, 13), // "wWorksBrowser"
QT_MOC_LITERAL(1, 14, 6), // "filter"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "print"
QT_MOC_LITERAL(4, 28, 16) // "businessSelected"

    },
    "wWorksBrowser\0filter\0\0print\0"
    "businessSelected"
};
...
const QMetaObject wWorksBrowser::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_wWorksBrowser.data,
      qt_meta_data_wWorksBrowser,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *wWorksBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_wWorksBrowser.stringdata))
