...
#include "../../terminal/src/logindialog.h"
...
QT_MOC_LITERAL(1, 12, 10), // "userLogged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "user*"
QT_MOC_LITERAL(4, 30, 3), // "usr"
QT_MOC_LITERAL(5, 34, 6) // "accept"

    },
    "loginDialog\0userLogged\0\0user*\0usr\0"
    "accept"
};
...
void loginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&loginDialog::userLogged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void loginDialog::userLogged(user * _t1)
{
