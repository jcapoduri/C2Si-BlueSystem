...
**
** Created: Sat 2. Feb 03:27:00 2013
...
static const char qt_meta_stringdata_wUser[] = {
    "wUser\0\0u\0updated(user*)\0saved()\0"
    "closed()\0"
};
...
const QMetaObjectExtraData wUser::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject wUser::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_wUser,
      qt_meta_data_wUser, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &wUser::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_wUser))
