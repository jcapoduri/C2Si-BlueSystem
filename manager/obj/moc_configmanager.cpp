...
#include "../../terminal/src/configmanager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_configManager_t, stringdata) + ofs \
...
void *configManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_configManager.stringdata))
